...
class _FoodScreenState extends State<FoodScreen> {
  ...
  void _showAdd() {
    showGeneralDialog(
      ...
      pageBuilder: (ctx, _, _) => _AddMealSheet(
        onAdd: (m) {
          setState(() => FoodStore.meals.insert(0, m));
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: AppColors.food.withAlpha(100),
                                    blurRadius: 12,
                                  ),
                                ],
                              ),
                  ...
                  SizedBox(
                    ...
                    child: CircularProgressIndicator(
                      ...
                      valueColor: AlwaysStoppedAnimation(
                        over ? AppColors.danger : AppColors.food,
                      ),
                    ),
                  ),
                  Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 5),
                      Text(
                        '${goal - todayCals > 0 ? goal - todayCals : 0} REMAINING',
                        style: GoogleFonts.jetBrainsMono(
                          fontSize: 10,
                          fontWeight: FontWeight.w700,
                          letterSpacing: 1,
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 40,
            decoration: BoxDecoration(
              color: AppColors.food.withAlpha(20),
              shape: BoxShape.circle,
            ),
                        ...
                        children: widget.types.map((t) {
                          ...
                          return GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: active
                                    ? AppColors.food.withAlpha(25)
                                    : const Color(0xFFEFEBE0),
                                borderRadius: BorderRadius.circular(16),
                                border: Border.all(
                                  color: active
                                      ? AppColors.food.withAlpha(140)
                                      : divider,
                                ),
                              ),
                              child: Text(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: AppColors.food.withAlpha(70),
                                blurRadius: 14,
                                offset: const Offset(0, 4),
                              ),
                            ],
