        ...
        SafeArea(child: Column(children: [
          Padding(padding: const EdgeInsets.fromLTRB(20, 16, 20, 0),
            child: Stack(alignment: Alignment.center, children: [
              Column(children: [
                Text('FOOD', style: GoogleFonts.playfairDisplay(
                  fontSize: 26, fontWeight: FontWeight.w800, letterSpacing: 3,
                  color: const Color(0xFFF0D4D0))),
                const SizedBox(height: 3),
                Text('$todayCals / $goal kcal today', style: GoogleFonts.inter(
              ...
              child: GestureDetector(onTap: _showAdd,
                child: Container(height: 56,
                  ...
                  child: Center(child: Row(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text('LOG  MEAL', style: GoogleFonts.playfairDisplay(
        ...
        child: Row(children: [
          SizedBox(width: 70, height: 70, child: Stack(alignment: Alignment.center, children: [
            ...
            Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text('KCAL', style: GoogleFonts.jetBrainsMono(
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              Text('$mealCount MEALS TODAY', style: GoogleFonts.jetBrainsMono(
            ...
            Row(children: [
              ...
              const SizedBox(width: 5),
              Text('${goal - todayCals > 0 ? goal - todayCals : 0} REMAINING', style: GoogleFonts.jetBrainsMono(
            ...
            Container(padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
              ...
              child: Text(over ? 'OVER LIMIT' : 'ON TRACK', style: GoogleFonts.jetBrainsMono(
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text(meal.type, style: GoogleFonts.jetBrainsMono(fontSize: 9, fontWeight: FontWeight.w600,
        ...
        Text(' kcal', style: GoogleFonts.inter(fontSize: 9, color: subCol)),
              ...
              child: SingleChildScrollView(child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Padding(padding: const EdgeInsets.fromLTRB(22, 12, 22, 8),
                  child: TextField(controller: _calCtrl,
                    ...
                    decoration: InputDecoration(hintText: '0 kcal',
                    ...
                    children: widget.types.map((t) {
                      ...
                      return GestureDetector(onTap: () => setState(() => _type = t),
                        child: AnimatedContainer(duration: const Duration(milliseconds: 150),
                          ...
                          child: Text(t, style: GoogleFonts.inter(fontSize: 10, fontWeight: FontWeight.w600,
                ...
                Padding(padding: const EdgeInsets.fromLTRB(18, 16, 18, 20),
                  child: GestureDetector(onTap: _submit,
                    child: Container(width: double.infinity, padding: const EdgeInsets.symmetric(vertical: 14),
                      ...
                      child: Center(child: Text('LOG MEAL', style: GoogleFonts.inter(
