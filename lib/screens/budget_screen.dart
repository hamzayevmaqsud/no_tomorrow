...
class _BudgetScreenState extends State<BudgetScreen> {
  ...
  void _showAdd() {
    showGeneralDialog(
      ...
      pageBuilder: (ctx, _, _) => _AddExpenseSheet(
        onAdd: (e) {
          setState(() => BudgetStore.expenses.insert(0, e));
          Navigator.of(ctx).pop();
        },
        nextId: '${BudgetStore.nextId++}',
                    ...
                    child: expenses.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (ctx, i) => _ExpenseCard(
                              expense: expenses[i],
                              onDelete: () => _delete(expenses[i].id),
                            ),
                          ),
                  ),
                ],
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                boxShadow: [
                                  BoxShadow(
                                    color: AppColors.budget.withAlpha(100),
                                    blurRadius: 12,
                                  ),
                                ],
                              ),
                      ...
                      SizedBox(
                        ...
                        child: CircularProgressIndicator(
                          ...
                          valueColor: AlwaysStoppedAnimation(
                            overBudget ? AppColors.danger : AppColors.budget,
                          ),
                        ),
                      ),
                      Text(
                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          const SizedBox(width: 5),
                          Text(
                            '\$${todaySpent.toStringAsFixed(0)} TODAY',
                            style: GoogleFonts.jetBrainsMono(
                              fontSize: 10,
                              fontWeight: FontWeight.w700,
                              letterSpacing: 1,
      ...
      child: Row(
        children: [
          Container(
            ...
            height: 40,
            decoration: BoxDecoration(
              color: AppColors.budget.withAlpha(20),
              shape: BoxShape.circle,
            ),
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Container(
                      decoration: BoxDecoration(
                        color: AppColors.budget.withAlpha(25),
                        ...
                        children: widget.categories.map((c) {
                          ...
                          return GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: active
                                    ? AppColors.budget.withAlpha(25)
                                    : const Color(0xFFEFEBE0),
                                borderRadius: BorderRadius.circular(16),
                                border: Border.all(
                                  color: active
                                      ? AppColors.budget.withAlpha(140)
                                      : divider,
                                ),
                              ),
                              child: Text(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: AppColors.budget.withAlpha(70),
                                blurRadius: 14,
                                offset: const Offset(0, 4),
                              ),
                            ],
